...
# =====================================================================
# MOTOR PPK HÍBRIDO DETERMINISTA (CÁLCULO EXACTO V14)
# =====================================================================
        ...
        for s in sat_list:
            ...
            if data['cp_r'] is not None and data['cp_b'] is not None and rc['cp_r'] is not None and rc['cp_b'] is not None:
                ...
                if cp_valid:
                    ...
                    # --- MODIFICACIÓN V14: Verificación rigurosa mediante Ratio Test ---
...
------------------------------------------------------------------------
  ...
  [-] Resolución de Enteros  : LAMBDA Z-Transform (Bootstrapping) + Ratio Test
